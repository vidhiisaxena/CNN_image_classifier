...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
      ...
      model_name=model_label.lower().strip()
      classifier_label=[label.strip() for label in model_name.split(",")]
      truth = results_dic[key][0].lower().strip()
      if truth in classifier_label:
        results_dic[key].extend([model_name,1])
      else:
        results_dic[key].extend([model_name,0])
